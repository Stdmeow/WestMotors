        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SoldCarsCount = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FullName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    PassportData = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CarModelApplicability = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ContactInfo = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    BankDetails = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AutoServiceEntries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AutoServiceEntries_AspNetUsers_MechanicId",
                        column: x => x.MechanicId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_AutoServiceEntries_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApplicationRequests_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsedPartsInService", x => new { x.ServiceId, x.PartId });
                    table.ForeignKey(
                        name: "FK_UsedPartsInService_AutoServiceEntries_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "AutoServiceEntries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsedPartsInService_SpareParts_PartId",
                        column: x => x.PartId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationRequests_CarId",
                table: "ApplicationRequests",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_ApplicationRequests_ClientId",
                table: "ApplicationRequests",
                column: "ClientId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AutoServiceEntries_CarId",
                table: "AutoServiceEntries",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_AutoServiceEntries_MechanicId",
                table: "AutoServiceEntries",
                column: "MechanicId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsedPartsInService_PartId",
                table: "UsedPartsInService",
                column: "PartId");
        }
